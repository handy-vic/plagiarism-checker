...
```bash
git clone https://github.com/handy-vic/plagiarism-checker
```
...
Explore it and twist it to your own use case. In case of any questions feel free to reach me directly at *vic2oke@gmail.com*.
